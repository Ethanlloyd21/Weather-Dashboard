...
## ALERT!
Users will be asked if they want the app to track their location. If yes, the app will output the user's location weather condition.
If no, the user will be ask to prompt a city in the search bar.
